    ...
    let personArray = [
      {
        name: "Oliver Speir",
        shortBio:
          "Hey I’m Oliver Speir! I’m a passionate Software Engineer with experience in full MERN stack.",
        ...
        gitHub: "https://github.com/OliverSpeir",
      },
      {
        name: "DeShon Dixon",
        shortBio:
          "Hey! I’m DeShon Dixon. US Army Veteran transitioning into software development.",
        ...
        imgSrc:
          "https://avatars.githubusercontent.com/u/107225817?s=400&u=e5bf8fd83578ecaaa45d1820a9101f13ef7646d0&v=4",
        linkedIn: "https://www.linkedin.com/in/deshondixon/",
        gitHub: "https://github.com/deshondixon",
      },
      {
        name: "Keyan Tabor",
        shortBio:
          "Keyan spent 4 years in the United States Marine Corps as an 0311 Infantryman.",
      ...
      return (
        ...
        >
          <Modal.Header closeButton>
            <img className="bioPic" src={item.imgSrc} alt={item.name} />
            <div>
              ...
              <div className="iconDiv">
                <a href={item.linkedIn}>
                  <img
                    ...
                    src="https://cdn3.iconfinder.com/data/icons/social-media-2253/17/Vector-4-512.png"
                    alt="LinkedIn icon"
                  />
                </a>
                <a href={item.gitHub}>
    ...
    return (
      <>
        <div className="glassContainer">
          <div className="about-margin">{allCards}</div>
        </div>
        {allModals}
      </>
    );
