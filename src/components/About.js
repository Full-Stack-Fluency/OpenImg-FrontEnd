...
class About extends Component {
  ...
  render() {
    ...
    let personArray =[{
      ...
      imgSrc: 'https://ca.slack-edge.com/T039KG69K-U043BMUTN8Y-af494fd60f05-512'
    }, 
    {
      Name:'DeShon Dixon' ,
    ...
    return (
      ...
      <img alt='Words, Sometimes they mean things, but not here' src= {personArray[this.state.id].imgSrc}/>
